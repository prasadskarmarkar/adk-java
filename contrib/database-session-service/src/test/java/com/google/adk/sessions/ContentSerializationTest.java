...
public class ContentSerializationTest {
  ...
  public void testTextPartRoundTrip() {
    ...
    sessionService.appendEvent(TEST_APP_NAME, TEST_USER_ID, sessionId, originalEvent).blockingGet();
  ...
  public void testMultiTurnConversationWithTools() {
    ...
    sessionService.appendEvent(TEST_APP_NAME, TEST_USER_ID, sessionId, userMessage).blockingGet();
    sessionService
        .appendEvent(TEST_APP_NAME, TEST_USER_ID, sessionId, modelFunctionCall)
        .blockingGet();
    sessionService.appendEvent(TEST_APP_NAME, TEST_USER_ID, sessionId, toolResponse).blockingGet();
    sessionService
        .appendEvent(TEST_APP_NAME, TEST_USER_ID, sessionId, modelFinalResponse)
        .blockingGet();
  ...
  public void testEmptyAndNullContent() {
    ...
    sessionService
        .appendEvent(TEST_APP_NAME, TEST_USER_ID, sessionId, emptyContentEvent)
        .blockingGet();
